...
class MatchPlayerInfo extends Component {
        ...
        for (let i = 0; i < this.state.participants.length; i++) {
            for (let j = 0; j < this.state.champKeyPairs.length; j++) {
                ...
                if (
                    ...
                    // console.log(
                    //     "this.state.champKeyPairs[j].name",
                    //     this.state.champKeyPairs[j].name
                    // );
                    let tempParticipant = Object.assign(
                        {},
                        this.state.participants[i]
                    );
                    tempParticipant.championName = this.state.champKeyPairs[
                        j
                    ].name;
                    tempParticipantsArr.push(tempParticipant);
                    //Breaks loop
                    // console.log(
                    //     "tempParticipantsArr.length",
                    //     tempParticipantsArr.length
                    // );
    ...
    parseUsername = () => {
        // console.log("this.state.participantIdentities[0]", this.state.participantIdentities[0]);
        let tempParticipantsArr = [];
        for (let i = 0; i < this.state.participants.length; i++) {
        ...
        for (let i = 0; i < this.state.participants.length; i++) {
            for (let j = 0; j < this.state.summonerKeyPairs.length; j++) {
                if (
                    ...
                    tempParticipant.spell1IdName = this.state.summonerKeyPairs[
                        j
                    ].name;
                    tempParticipantsArr.push(tempParticipant);
                    //
        ...
        for (let i = 0; i < this.state.participants.length; i++) {
            for (let j = 0; j < this.state.summonerKeyPairs.length; j++) {
                if (
                    ...
                    tempParticipant.spell2IdName = this.state.summonerKeyPairs[
                        j
                    ].name;
                    tempParticipantsArr.push(tempParticipant);
                    //
            ...
            <div className="MatchPlayerInfo">
                {this.state.participants.map((partData, index) => (
                    <MatchPlayerPanel
                        ...
                        win={partData.win}
                        championId={[
                            `http://ddragon.leagueoflegends.com/cdn/img/champion/tiles/${
                        ...
                        playerPage={[
                            `/summoner/${partData.participantId}/NA`
                        ].join(" ")}
                        cs={partData.cs}
                        csPM={partData.csPM}
                        kda={partData.kda}
                        ...
                        item0={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item0
                            }.png`
                        ].join(" ")}
                        item1={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item1
                            }.png`
                        ].join(" ")}
                        item2={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item2
                            }.png`
                        ].join(" ")}
                        item3={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item3
                            }.png`
                        ].join(" ")}
                        item4={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item4
                            }.png`
                        ].join(" ")}
                        item5={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item5
                            }.png`
                        ].join(" ")}
                        item6={[
                            `http://ddragon.leagueoflegends.com/cdn/9.9.1/img/item/${
                                partData.stats.item6
                            }.png`
                        ].join(" ")}
                    />
                ))}
