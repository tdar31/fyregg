        ...
        for (let h = 0; h < this.state.matchData.length; h++) {
            ...
            for (
                ...
                if (
                    ...
                    let playerId =
                        matchDataArray.participantIdentities[i].participantId;
                    ...
                    for (let j = 0; j < 10; j++) {
                        if (
                            matchDataArray.participants[j].participantId ===
                            playerId
                        ) {
                            let compiledPlayerData =
                                matchDataArray.participants[j];
                            compiledPlayerData.gameCreation =
                                matchDataArray.gameCreation;
                            compiledPlayerData.gameDuration =
                                matchDataArray.gameDuration;
                            compiledPlayerData.gameMode =
                                matchDataArray.gameMode;
                            compiledPlayerData.gameType =
                                matchDataArray.gameType;
                            compiledPlayerData.gameVersion =
                                matchDataArray.gameVersion;
                            compiledPlayerData.queueId = matchDataArray.queueId;
                            compiledPlayerData.seasonId =
                                matchDataArray.seasonId;
                            compiledPlayerData.teams = matchDataArray.teams;
                            compiledPlayerData.platformId =
                                matchDataArray.platformId;
                    ...
                    <ProfileBody>
                        <UserBanner>
                            <UserModule
                                ...
                                profileIcon={[
                                    `http://ddragon.leagueoflegends.com/cdn/9.12.1/img/profileicon/${
                                        this.state.profile.profileIconId
                                    }.png`
                                ].join(" ")}
                                // handleOnUpdateClick={this.handleOnUpdateClick}
                            />
                            {this.state.rankedStats.map(
                                (rankedPlayerData, index) => (
                                    <RankedModule
                                        key={index}
                                        leaguePoints={
                                            rankedPlayerData.leaguePoints
                                        }
                                        ...
                                        rankIcon={[
                                            `/images/ranked/${
                                                rankedPlayerData.tier
                                            }_${rankedPlayerData.rank}.png`
                                        ].join(" ")}
                                    />
                                )
                            )}
                        ...
                        <UserBody>
                            {" "}
                            <GameContainer>
                                {this.state.selectedPlayerData.map(
                                    (playerData, index) => (
                                        <GameItem
                                            key={index}
                                            gameCreation={
                                                playerData.gameCreation
                                            }
                                            gameDuration={
                                            ...
                                            champLevel={
                                                playerData.stats.champLevel
                                            }
                                            deaths={playerData.stats.deaths}
                                            goldEarned={
                                                playerData.stats.goldEarned
                                            }
                                            goldSpent={
                                                playerData.stats.goldSpent
                                            }
                                            item0={[
                                                `http://ddragon.leagueoflegends.com/cdn/9.12.1/img/item/${
