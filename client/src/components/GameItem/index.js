...
class GameItem extends Component {
    ...
    componentWillMount() {
        ...
        for (var key in summonerJsonData.data) {
            ...
            console.log("summonerKeysArr: ", summonerKeysArr);
            console.log("summonerKeysName: ", summonerKeysName);
            let sums = {
                id: summonerKeysArr,
    ...
    componentDidMount() {
        ...
        let creepS =
            (+this.props.totalMinionsKilled +
                +this.props.neutralMinionsKilled) /
            minutes;
        //Total Creep Score
        let cs =
        ...
        return (
            <div className="GameItem">
                ...
                <GameModuleStatsInfo
                    ...
                    perkSubStyle={
                        process.env.PUBLIC_URL + this.props.perkSubStyle
                    }
